let bosses = [
  {
    ...
    abilities: [
      {
        abilityId: 69055,
        comment: 'Танки повинні стакнутись і ділити урон',
      },
      {
        abilityId: 69146,
  ...
  },
  {
    ...
    abilities: [
      {
        abilityId: 70842,
        comment: 'Фаза 1. Поки не спалиш всю ману, босс не двигається і не пиздить з руки. Наносиш урон - палиш ману',
      },
      {
        abilityId: 71254,
  ...
  },
  {
    ...
    abilities: [
      {
        abilityId: 72371,
        comment: 'Саурфанг стакає на собі баф на + урон. 1 енергії = 1% урона.',
      },
      {
        abilityId: 72178,
        comment: 'Саурфанг отримує +1 енергії кожен раз коли він, або моби наносять урон абілкою.',
      },
      {
        abilityId: 72293,
        comment: 'Основна механіка для хілів. Як тіки босс набирає 100 енергії він кидає в рандомний таргет марку. Марка не знімається, залишається на гравці до кінця бою. Наносить фіз урон. Можна кинути боп, шоб гравець не отримував дамаг.',
      },
      {
        abilityId: 72737,
      ...
      {
        abilityId: 72380,
        comment: 'Кастується в рандомний таргет. Наносить урон в АоЕ 12 ярдів. Треба спред.',
      },
      {
        abilityId: 72408,
  ...
  },
  {
    ...
    abilities: [
      ...
      {
        abilityId: 72219,
        comment: 'Основна механіка для танків. Стакає дебаф на танку. Який дає +10% до урона.',
      },
      {
        abilityId: 72227,
  ...
  },
  {
    ...
    abilities: [
      ...
      {
        abilityId: 69839,
        comment: 'Коли великий слизнюк набирає 5 стаків бафа він взривається і розлітається на 8 кусків, які нанесуть по ~15к урона в рандомних гравців і АоЕ в 6 ярдів. Треба спред.',
      },
    ],
  },
  {
    ...
    abilities: [
      ...
      {
        abilityId: 71621,
        comment: 'Перефазовка на 80% і 35% хп босса. Проф іде до свого стола і станить весь рейд + дає іммун до всього дамага. Ніяк не доджиться',
      },
      {
        abilityId: 71603,
      ...
      {
        abilityId: 70701,
        comment: 'Оранжевий слизнюк, коли доходить до свого таргета наносить рейду урон в залежності від кількості стаків дебафа на таргеті.',
      },
      {
        abilityId: 70447,
        comment: 'Зелений слизнюк, рутає свій таргет. Якшо доходить, то наносить ~250к урона, в АоЕ. Цей дамаг сплітається на всіх хто його отримав',
      },
      {
        abilityId: 70311,
  ...
  },
  {
    ...
    abilities: [
      ...
      {
        abilityId: 70107,
        comment: 'Phase 1/3: Land. Фіз атаки стакають дебаф. Каждий стак 1000 урона/2 сек.',
      },
      {
        abilityId: 69762,
        comment: 'Phase 1/3: Land. Дебаф. Поки він на тобі є і ти шось кастуєш. Ти стакаєш дебаф. І получаєш в їбало 2к дамага. Більше кастуєш - більше дамага получаєш.',
      },
      {
        abilityId: 70117,
      ...
      {
        abilityId: 70123,
        comment: 'Phase 1/3: Land. Сразу після стяжки кастує АоЕ по всьому рейду, потрібно прожати сейви.',
      },
      {
        abilityId: 70126,
  ...
  },
  {
    ...
    abilities: [
      ...
      {
        abilityId: 70337,
        comment: 'Болячка, вішається на рандомний таргет. 15 секунд, дамажить кожних 5 секунд по 50к. При діспелі перекидається на інший рандомний таргет. При розвіюванні (діспел, смерть таргета) бафає ліча на 2% дамага. Потрібно діспелити в останню секунду перед дамагом.',
      },
      {
        abilityId: 70541,
      ...
      {
        abilityId: 69200,
        comment: 'Дух, який б\'є рандомний таргет, його потрібно вбити',
      },
    ],
  },
];
